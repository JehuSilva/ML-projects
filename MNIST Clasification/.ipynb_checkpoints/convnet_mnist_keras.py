...
# El modelo consiste de dos capas convolucionales, una de maxpooling y una completamente conectada
model = Sequential([
...
# Adadelta adapta dinamicamente el paso de aprendizaje de manera inversamente proporcional al gradiente
...
# Se llega al 98.5% precision de test
